...
setContent: function(arrt, val) {
    ...
    build: function() {
        ...
        var path = "";
        var close = '<img id="dialogBoxClose" src="../common/Images/closewin.gif" onclick="ClosePop();" border="0" width="28" height="15" align="absmiddle" />';
    ...
    setBackgroundSize: function() {
        ...
        G('dialogBoxBG').style.width = document.body.clientWidth;
        var getValueHeight;
    ...
    lastBuild: function() {
        var confirm = '<div style="width:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">' + this.info.confirmCon + '</div><div style="padding:20px;"><input id="dialogOk" type="button" value=" ȷ�� "/>&nbsp;<input id="dialogCancel" type="button" value=" ȡ�� "/></div></div>';
        var alert = '<div style="width:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">' + this.info.alertCon + '</div><div style="margin:20px;"><input id="dialogYES" type="button" value=" ȷ�� "/></div></div>';
        var baseZIndex = 10001 + this.info.overlay * 10;
